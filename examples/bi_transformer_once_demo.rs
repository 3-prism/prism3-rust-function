...
fn main() {
    ...
    let result = add.transform(20, 22);
    ...
    println!("   conditional(4, 6) = {}", conditional3.transform(4, 6));
    ...
    let (sum, product) = calculate.transform(5, 3);
    ...
    println!("   boxed(15, 25) = {}", boxed.transform(15, 25));
